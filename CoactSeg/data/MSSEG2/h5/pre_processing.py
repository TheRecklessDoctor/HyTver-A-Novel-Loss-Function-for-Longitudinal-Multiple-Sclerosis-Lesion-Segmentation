...
listt = sorted(glob('./CoactSeg/data/MSSEG2/h5/preProcessed/*'))
# original_data_path should be the path to the original unskull-stripped files as for precaution's sake we use the 
# ground-truths from the original files. This satisfy's my fear of label corruption by HD-BET. I am paranoid.
...
for item in tqdm(listt):
    ...
    first_point_mask_name = name+"/flair_time01_on_middle_space_bet.nii.gz"
    second_point_name = name+"/flair_time02_on_middle_space.nii.gz"
    second_point_mask_name = name+"/flair_time01_on_middle_space_bet.nii.gz"

    gt_name = original_data_path + name_id +"/ground_truth.nii.gz"
    ...
    sitk.WriteImage(image_cropped, "./CoactSeg/data/MSSEG2/h5/images/"+str(name_id)+"_first_point.nii.gz")
    ...
    image_cropped.SetDirection(direction)
    image_cropped.SetSpacing(space)
    sitk.WriteImage(image_cropped, "./CoactSeg/data/MSSEG2/h5/images/"+str(name_id)+"_second_point.nii.gz")
    ...
    image_cropped.SetDirection(direction)
    image_cropped.SetSpacing(space)
    sitk.WriteImage(image_cropped, "./CoactSeg/data/MSSEG2/h5/labels/"+str(name_id)+".nii.gz")

    f = h5py.File(('./CoactSeg/data/MSSEG2/h5/data'+str(name_id) + '_norm.h5'), 'w')
    ...
    sitk.WriteImage(image_cropped_save1, "./CoactSeg/data/MSSEG2/h5/images/"+str(name_id)+"_1.nii.gz")
    ...
    sitk.WriteImage(image_cropped_save2, "./CoactSeg/data/MSSEG2/h5/images/"+str(name_id)+"_2.nii.gz")
    ...
    sitk.WriteImage(label_cropped_save, "./CoactSeg/data/MSSEG2/h5/labels/"+str(name_id)+".nii.gz")
